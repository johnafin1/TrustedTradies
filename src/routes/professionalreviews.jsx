...
const reviewData = [
    
  {
    ...
    reviewDescription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus aliquet tristique nulla, sed rhoncus elit tempor in.',
    date: '2023-05-20',
    rating: 4.5
  },
  {
    ...
    reviewDescription: 'Sed eget mauris arcu. Integer at tortor felis. Donec eget commodo elit, ut semper ex.',
    date: '2023-05-18',
    rating: 5.0
  },
  {
    ...
    reviewDescription: 'Curabitur consectetur fringilla augue, id finibus nunc. Phasellus non semper nunc, sit amet commodo ante.',
    date: '2023-05-16',
    rating: 4.0
  }
];
...
<br />
        ...
        <div className="row justify-content-center">
          <div className="col-lg-4">
            ...
            <div className="card border-0">
              <div className="card-body">
                <h5 className="card-title">Average Rating: {calculateAverageRating().toFixed(1)}</h5>
              </div>
            </div>
          </div>
        </div>
      ...
      <Modal show={showModal} onHide={handleCloseModal}>
        ...
        <Modal.Body>
          ...
          {selectedReview && (
            <div>
              <p><strong>Client Name:</strong> {selectedReview.clientName}</p>
              <p><strong>Work Requested:</strong> {selectedReview.workRequested}</p>
              <p><strong>Review Description:</strong> {selectedReview.reviewDescription}</p>
